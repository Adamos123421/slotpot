    ...
    try {
      ...
      if (freshContractState.lastWinner) {
        ...
        const winnerData = {
          ...
          username: winnerBettor?.username || winnerBettor?.displayName || `Player_${freshContractState.lastWinner?.slice(-4)}`,
          winnerName: winnerBettor?.username || winnerBettor?.displayName || `Player_${freshContractState.lastWinner?.slice(-4)}`,
